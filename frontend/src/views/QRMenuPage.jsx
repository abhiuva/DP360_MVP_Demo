      ...
      <div className="container mx-auto px-4">
                ...
                >
                  <div>
                    <div className="rounded-2xl w-32 h-32 object-cover relative bg-gray-200 flex items-center justify-center text-gray-500 ">
                      ...
                      {is_qr_order_enabled && (
                        <button
                          className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 text-salespos-green bg-white border border-salespos-green py-1 px-6 rounded-lg font-bold hover:bg-salespos-green hover:text-white"
                          onClick={(e) => {
                            e.stopPropagation();
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-salespos-green font-bold">
                      {currency}
                      {price}
                    </p>
                    {category_id && (
        ...
        {is_qr_order_enabled && cartItems.length > 0 && (
          ...
          >
            ...
            className="bg-salespos-green text-white py-4 px-6 flex justify-between items-center rounded-xl w-full">
              ...
              <div className="modal-action flex justify-end w-full">
                <form method="dialog" className="w-full">
                  <button
                    ...
                    className="w-full rounded-lg hover:bg-red-400 transition active:scale-95 hover:shadow-lg px-6 py-2 bg-salespos-green text-white font-bold"
                  >
                    ADD TO CART
                  </button>
                </form>
