    ...
    <Page className="px-4 py-3 overflow-x-hidden h-full">
      <div className="flex gap-6 items-center mb-6 mt-6">
        ...
        <button
          ...
          className="bg-salespos-green text-white text-sm px-6 py-2 rounded-[42px] hover:bg-salespos-green/80"
        >
          Add Tenant
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-6">
        <button
          className={clsx(
            'flex flex-col p-6 gap-1 rounded-3xl border border-salespos-border-green-light bg-[url(/assets/wave-bg.svg)] bg-cover bg-right cursor-pointer',
            {
              'border-2 border-salespos-green/90': state.status === 'active',
            }
          )}
        ...
        >
          ...
          <span className="text-4xl lg:text-5xl font-black text-salespos-green">
            {state.activeTenants}
          </span>
        </button>

        <button
          className={`flex flex-col p-6 gap-1 rounded-3xl border border-salespos-border-green-light cursor-pointer ${
            state.status === "inactive" ? "border-2 border-salespos-green/90" : ""
          }`}
        ...
        <button
          className={`flex flex-col p-6 gap-1 rounded-3xl border border-salespos-border-green-light cursor-pointer ${
            state.status === "" ? "border-2 border-salespos-green/90" : ""
          }`}
      ...
      <div className="flex flex-col px-6 py-6 border border-salespos-border-green-light rounded-3xl">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-2">
          ...
          <button
            ...
            className="mt-2 sm:mt-0 bg-salespos-green text-white text-sm px-4 sm:px-6 py-2 rounded-[42px] hover:bg-salespos-green/80 whitespace-nowrap w-full sm:w-auto"
          >
            {state.status !== ""
              ? `Export ${
                  state.status.charAt(0).toUpperCase() + state.status.slice(1)
