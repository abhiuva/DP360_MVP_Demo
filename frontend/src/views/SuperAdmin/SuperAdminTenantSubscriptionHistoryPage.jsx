    ...
    <Page>
      ...
      <div className="flex flex-col lg:flex-row gap-4 mt-6">
        <div className="w-full lg:w-4/12 border rounded-3xl px-5 py-6">
          ...
          {tenantInfo.is_active == 1 && <div className='w-fit flex items-center justify-center text-sm rounded-full  text-salespos-green-dark'><IconCheck className='text-salespos-green' stroke={iconStroke} /> Active</div>}
          {tenantInfo.is_active == 0 && <div className='w-fit flex items-center justify-center text-sm rounded-full  text-salespos-green-dark'><IconX className='text-red-500' stroke={iconStroke} /> InActive</div>}
            ...
            {subscriptionHistory.map((item, i)=>{
              ...
              return (
                <div key={i} className="flex items-center gap-4 w-full">
                  <div className="w-16 h-16 rounded-xl bg-salespos-green-light text-salespos-green flex items-center justify-center">
                      ...
                      <div
                        className={`text-xs font-semibold py-1 px-3 rounded-full w-20 sm:w-18 text-center ${
                          status === "cancelled"
                            ...
                            : status === "created"
                            ? "bg-green-100 text-red-500 border border-green-500"
