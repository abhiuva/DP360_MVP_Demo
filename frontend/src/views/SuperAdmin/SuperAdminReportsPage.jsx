  ...
  return (
    <Page className='px-4 py-3 overflow-x-hidden h-full'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mt-6">
        ...
        <div className='md:row-span-3 h-[28rem] bg-salespos-superadmin-widget-bg rounded-[42px] overflow-hidden'>
        ...
        <div className='rounded-[42px] border border-salespos-border-green-light px-8 py-5 flex flex-col justify-center'>
          ...
          <p className='font-black text-5xl text-salespos-superadmin-text-black mt-2'>{Number(ordersProcessed).toLocaleString("en",{notation: "compact"})}</p>
        </div>

        <div className='rounded-[42px] border border-salespos-border-green-light px-8 py-5 flex flex-col justify-center'>
          <p className='font-bold'>All Tenant's Customers</p>
          <p className='font-black text-5xl text-salespos-superadmin-text-black mt-2'>{Number(totalCustomers).toLocaleString("en",{notation: "compact"})}</p>
        </div>
      </div>
