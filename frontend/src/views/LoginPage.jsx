...
export default function LoginPage() {
  ...
  return (
    ...
    <div className="bg-salespos-green-light relative overflow-x-hidden md:overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-center justify-end md:justify-between gap-10 h-screen container mx-auto px-4 md:px-0 py-4 md:py-0 relative">
        <div>
          <h3 className="text-2xl lg:text-6xl font-black text-salespos-green-dark">Cafe. Restaurant.</h3>
          <h3 className="text-2xl lg:text-6xl font-black text-salespos-green-light outline-text">Hotel. Bar.</h3>
        </div>
        <div className="bg-white rounded-2xl px-8 py-8 w-full sm:w-96 mx-8 sm:mx-0 shadow-2xl">
          <div className="flex items-center justify-between">
            <div className="text-salespos-green-dark text-xl font-medium">
              Login
            </div>
            <div>
          ...
          <form className="mt-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="block w-full mt-6 bg-salespos-green text-white rounded-xl px-4 py-3 transition hover:scale-105 active:scale-95 hover:shadow-xl hover:shadow-green-800/20"
            >
              Login
            </button>
            ...
            {/* Create account unnecessary as it is intended to be done through our database servers and not the users. */}
            {/* Registration page unnecessary */}
            {/* <Link
              to="/register"
