...
export default function MenuItemViewPage() {
  ...
  async function btnSave() {
    ...
    if (!inventoryId) {
      toast.error("Please link the inventory item!");
      return;
    }

    try {
      toast.loading("Please wait...");
      const res = await updateMenuItem(id, title, price, netPrice, categoryId, taxId, discount,status,  inventoryId);
    ...
    <Page className="px-4 md:px-8 py-3 md:py-6">
	  ...
	  {/* variants */}
          <div className="bg-gray-50 mt-6">
            {/* Using details and summary for collapse functionality */}
            <details className="group">
              {/* Summary acts as the clickable title */}
              <summary className="collapse-title font-medium cursor-pointer">
                Show Variant
              </summary>

              {/* Collapse content, which will show when the details element is expanded */}
              <div className="flex flex-col mt-4">
                {
                  variants.map((variant) => {
                    return (
                      <div key={variant.id} className="flex items-center justify-between hover:bg-gray-100 transition p-2 rounded-lg cursor-pointer">
                        <div className="flex-1">
                          <p>{variant.title}</p>
                ...
                {/* Button to show modal for adding a variant */}
                <button
            ...
            <div className="flex flex-col mt-4">
              {
                addons.map((addon) => {
                  return (
                    <div key={addon.id} className="flex items-center justify-between hover:bg-gray-100 transition p-2 rounded-lg cursor-pointer">
                      <div className="flex-1">
                        <p>{addon.title}</p>
              ...
              {/* Button to show modal for adding an addon */}
              <button
      ...
      <dialog id="modal-add-variant" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <input ref={variantTitleRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-salespos-border-green-light" placeholder="Enter Variant Title" />
          </div>

          <div className="my-4">
            <label htmlFor="price" className="mb-1 block text-gray-500 text-sm">Variant Price</label>
            <input ref={variantPriceRef} type="number" name="price" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-salespos-border-green-light" placeholder="Enter Variant Price" />
          ...
          <div className="modal-action">
            <form method="dialog">
              ...
              <button onClick={() => { btnAddVariant(); }} className="rounded-lg hover:bg-red-400 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-salespos-green text-white ml-3">Save</button>
            </form>
          </div>
        </div>
      </dialog>
      ...
      <dialog id="modal-update-variant" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <label htmlFor="title" className="mb-1 block text-gray-500 text-sm">Variant Title</label>
            <input ref={variantTitleUpdateRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-salespos-border-green-light" placeholder="Enter Variant Title" />
          </div>

          <div className="my-4">
            <label htmlFor="price" className="mb-1 block text-gray-500 text-sm">Variant Price</label>
            <input ref={variantPriceUpdateRef} type="number" name="price" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-salespos-border-green-light" placeholder="Enter Variant Price" />
          ...
          <div className="modal-action">
            <form method="dialog">
              {/* if there is a button in form, it will close the modal */}
              <button className="rounded-lg hover:bg-gray-200 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-gray-200 text-gray-500">Close</button>
              <button onClick={() => { btnUpdateVariant(); }} className="rounded-lg hover:bg-red-400 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-salespos-green text-white ml-3">Save</button>
            </form>
          </div>
        </div>
      </dialog>
      ...
      <dialog id="modal-add-addon" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <input ref={addonTitleRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-salespos-border-green-light" placeholder="Enter Addon Title" />
          </div>

          <div className="my-4">
            <label htmlFor="price" className="mb-1 block text-gray-500 text-sm">Addon Price</label>
            <input ref={addonPriceRef} type="number" name="price" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-salespos-border-green-light" placeholder="Enter Addon Price" />
          ...
          <div className="modal-action">
            <form method="dialog">
              {/* if there is a button in form, it will close the modal */}
              <button className="rounded-lg hover:bg-gray-200 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-gray-200 text-gray-500">Close</button>
              <button onClick={() => { btnAddAddon(); }} className="rounded-lg hover:bg-red-400 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-salespos-green text-white ml-3">Save</button>
            </form>
          </div>
        </div>
      </dialog>
      ...
      <dialog id="modal-update-addon" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <label htmlFor="title" className="mb-1 block text-gray-500 text-sm">Addon Title</label>
            <input ref={addonTitleUpdateRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-salespos-border-green-light" placeholder="Enter Addon Title" />
          </div>

          <div className="my-4">
            <label htmlFor="price" className="mb-1 block text-gray-500 text-sm">Addon Price</label>
            <input ref={addonPriceUpdateRef} type="number" name="price" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-salespos-border-green-light" placeholder="Enter Addon Price" />
          ...
          <div className="modal-action">
            <form method="dialog">
              {/* if there is a button in form, it will close the modal */}
              <button className="rounded-lg hover:bg-gray-200 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-gray-200 text-gray-500">Close</button>
              <button onClick={() => { btnUpdateAddon(); }} className="rounded-lg hover:bg-red-400 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-salespos-green text-white ml-3">Save</button>
            </form>
          </div>
        </div>
      </dialog>
