...
export async function addMenuItem(title, price, netPrice, categoryId, taxId, discount, status, inventoryId) {
  try {
...
export async function updateMenuItem(id, title, price, netPrice, categoryId, taxId, discount, status, inventoryId) {
  try {
