...
// ✅ FIXED: Update via ID and allow phone number updates
export async function updateCustomer(id, phone, name, email, birthDate, gender) {
  try {
    const response = await ApiClient.post(`/customers/${id}/update`, {
      phone,
      name,
      email,
      birthDate,
